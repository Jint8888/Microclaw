...
- **Understand Tools:** Agent Zero includes default tools like knowledge, code execution, and communication. Understand the capabilities of these tools and how to invoke them.
