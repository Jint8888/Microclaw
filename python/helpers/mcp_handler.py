...
class MCPClientRemote(MCPClientBase):
    ...
    async def _create_stdio_transport(
        ...
        # Use configured timeouts (removed hard-coded min limits for long-running tools like TTS)
        init_timeout = server.init_timeout or set["mcp_client_init_timeout"]
        tool_timeout = server.tool_timeout or set["mcp_client_tool_timeout"]
